          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($actions['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="center" <?php echo $style;?> width="120"><?php echo $actions['date_start']; ?></td>
              <td class="center" <?php echo $style;?> width="120"><?php echo $actions['date_end']; ?></td>
              <td class="left" <?php echo $style;?>><?php foreach ($actions['action'] as $action) { ?>
                <a<?php if(!$actions['status'])echo ' style="color:#999999;"';?> href="<?php echo $action['href']; ?>"><b><?php echo $actions['caption']; ?></b></a> 
                <?php } ?></td>
              <td class="right"><?php foreach ($actions['action'] as $action) { ?>
