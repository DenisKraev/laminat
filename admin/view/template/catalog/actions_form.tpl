...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-seo"><?php echo $tab_seo; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="actions_description[<?php echo $language['language_id']; ?>][caption]" size="100" value="<?php echo isset($actions_description[$language['language_id']]) ? $actions_description[$language['language_id']]['caption'] : ''; ?>" />
                  <?php if (isset($error_caption[$language['language_id']])) { ?>
                  <span class="error"><?php echo $error_caption[$language['language_id']]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><?php echo $entry_anonnce; ?></td>
                <td><textarea name="actions_description[<?php echo $language['language_id']; ?>][anonnce]" cols="40" rows="5"><?php echo isset($actions_description[$language['language_id']]) ? $actions_description[$language['language_id']]['anonnce'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_description; ?></td>
                <td><textarea name="actions_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($actions_description[$language['language_id']]) ? $actions_description[$language['language_id']]['description'] : ''; ?></textarea>
              ...
              <tr>
                ...
                <td><textarea name="actions_description[<?php echo $language['language_id']; ?>][content]" id="content<?php echo $language['language_id']; ?>"><?php echo isset($actions_description[$language['language_id']]) ? $actions_description[$language['language_id']]['content'] : ''; ?></textarea>
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">
                    <?php if (in_array(0, $actions_store)) { ?>
                    <input type="checkbox" name="actions_store[]" value="0" checked="checked" />
                    <?php echo $text_default; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="actions_store[]" value="0" />
                    <?php echo $text_default; ?>
                    <?php } ?>
                  </div>
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input type="checkbox" name="actions_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                    <?php echo $store['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="actions_store[]" value="<?php echo $store['store_id']; ?>" />
                    <?php echo $store['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
        ...
        <table class="form">
        	<tr>
				<td><?php echo $entry_relproducts; ?></td>
				<td>
				<table>
					<tr>
						...
						<select id="categoryProduct" style="margin-bottom: 5px;" onchange="getProducts();">
							...
							<?php } ?>
						</select><input name="filter_special" type="checkbox" onchange="getProducts()" /><?php echo $entry_all_products?></td>
					</tr>
					<tr>
						<td style="padding:0;">
						...
						<td style="padding:0;"><select multiple="multiple" id="relProduct" size="10" style="width:245px; height:150px;"></select></td>
					</tr>
				</table>
